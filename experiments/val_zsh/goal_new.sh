...
MODEL="path/to/your/openvla/pretrained_checkpoint_for_goal_new"
TASK="libero_goal_new"
WANDB_ENTITY="agent_eval"
# ---- New: timestamped log directory ----
BASE_LOG_DIR="path/to/your/experiments/cache/log/eval/goal_new_time"
...
python -u "$MAIN_PY" --pretrained_checkpoint "$MODEL" --task_suite_name "$TASK" --num_trials_per_task=50 --wandb_entity "$WANDB_ENTITY" >>"$MAIN_LOG" 2>&1 &
MAIN_PID=$!
