...
MODEL_PATH = "/zhaohan/ZJX/Agentic_VLA/code/openvla/vla_finetune/libero_spatial_no_noops/openvla+libero_spatial_no_noops+b24+lr-0.001+lora-r32+dropout-0.0--image_aug--45000_chkpt"
SYSTEM_PROMPT = (
...
def verify_openvla() -> None:
    ...
    for _ in range(30):
        ...
        print(f"\t=>> Time: {time.time() - start_time:.4f} || processors finished")
